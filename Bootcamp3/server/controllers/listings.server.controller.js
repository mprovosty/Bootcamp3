...
exports.update = async function (req, res) {
  var listingToFind = req.listing;
  /* Replace the listings's properties with the new properties found in req.body */
  var listing = await Listing.findOneAndUpdate ({ _id: listingToFind.id },
    { $set: { code: req.body.code, name: req.body.name, address: req.body.address } }, { new: true },
  ...
  if (listing.results) {
    listing.coordinates = {
      latitude: req.body.results.lat, 
      longitude: req.body.results.lng
    };
  }
  /* Save the listing */
  listing.save (function (err) {
...
exports.delete = function (req, res) {
  ...
  Listing.findOneAndDelete ({ _id: listing.id }, function (err, listing) {
    if (err) {
      console.log (err);
      res.status (404).send (err);
    }
